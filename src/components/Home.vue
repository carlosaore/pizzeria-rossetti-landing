  ...
  >
    <div class="my-6 px-6">
      <p class="has-text-centered">
        En Pizzeria Rossetti Manises elaboramos de manera artesanal nuestras pizzas y con ingredientes 100%
        naturales, disponemos de un tamaño unico de pizza de 33cm con el que seguro te quedaras satisfecho,
        seguimos sumando años de historia ¡ya van 20 años!
      </p>
    </div>
    <div class="my-6 px-6">
