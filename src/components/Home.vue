...
<template>
  <section class="hero">
    <div class="hero-body">
      <p class="title is-1 has-text-centered">PIZZERIA ROSSETTI</p>
      <p class="subtitle has-text-centered">Tradición italiana</p>
    </div>
  </section>
  <img id="hero-pizza" alt="Pizza" src="/src/assets/hero-pizza.jpg" />
  <div class="container">
    <div class="my-6 px-6">
      <p class="has-text-centered">
        En Pizzeria Rossetti Manises elaboramos de manera artesanal nuestras pizzas y con ingredientes 100% naturales,
        disponemos de un tamaño unico de pizza de 33cm con el que seguro te quedaras satisfecho, seguimos sumando años
        de historia ¡ya van 20 años!
      </p>
    </div>
    <div class="my-6 px-6">
      <p class="title is-4 has-text-centered mb-2">Nuestra carta</p>
      <p class="has-text-centered">Los más vendidos</p>
      <div class="columns mt-6">
        <div class="column is-half">
          <div class="box pizza-item" @click="handleClickPizza('quattro-formaggi')">
            <p class="mb-0">QUATTRO FORMAGGI</p>
            <p class="mb-0">8,90€</p>
            <p class="ingredients">Ingredientes: Tomate, mozzarella, emental, roquefort y parmesano</p>
          </div>
          <div class="box pizza-item" @click="handleClickPizza('cosa-nostra')">
            <p class="mb-0">COSA NOSTRA</p>
            <p class="mb-0">8,90€</p>
            <p class="ingredients">Ingredientes: Tomate, mozzarella, pepperoni, bacon y cebolla</p>
          </div>
        </div>
        <div class="column is-half">
          <div class="box pizza-item" @click="handleClickPizza('deliziosa')">
            <p class="mb-0">DELIZIOSA</p>
            <p class="mb-0">10,50€</p>
            <p class="ingredients">Ingredientes: Tomate, mozzarella, roquefort, carne y parmesano</p>
          </div>
          <div class="box pizza-item" @click="handleClickPizza('margarita')">
            <p class="mb-0">MARGARITA</p>
            <p class="mb-0">6,50€</p>
            <p class="ingredients">Ingredientes: Tomate, mozzarella, oregano</p>
          </div>
        </div>
      </div>
  ...
  <div :class="{ 'is-active': isModalActive }" class="modal">
    ...
    <button aria-label="close" class="modal-close is-large" @click="closeModal"></button>
  </div>
</template>
